...
public class StarCollider : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D col)
    {
        ...
        //else if(t == "Guns" && !collided)
        //{
            Instantiate(starDrop, new Vector3(transform.position.x, transform.position.y, transform.position.z), Quaternion.identity);
            collided = true;
        //}
